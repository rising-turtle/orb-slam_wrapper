 ...
 *
 *  change plane3d.h in the original g2o, to be compatible with the types in orb's g2o
 *
 * */
...
namespace g2o {
  ...
  class Plane3D {
    public:
      ...
      friend Plane3D operator*(const SE3Quat& t, const Plane3D& plane);
  ...
  inline Plane3D operator*(const SE3Quat& t, const Plane3D& plane){
    Eigen::Vector4d v=plane._coeffs;
    Eigen::Vector4d v2;
    // Eigen::Matrix3d R=t.rotation();
    v2.head<3>() = t.rotation()*v.head<3>();
